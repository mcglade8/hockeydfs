...
matrix_vector <- c(vsalary, vcenter, vwing, vdef, vgoal, vstack1,vstack2,  vplayer, vselect_limit, vskaters, vcore, vteams) #vteams must be listed last
...
# 
# ## Define constraints and direction - 50000 salary
const.rhs = c(50000,    2,   3,   2,   1,    1,    1,    8-stack1size-stack2size,    11-stack1size-stack2size,    8,    stacks_in_core)
const.dir = c("<=" , ">=",">=",">=","==", "==", "==",                       "==",                        "==", "==",              ">=")
